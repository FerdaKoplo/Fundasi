...
const UserCampaign: React.FC<UserCampaignProps> = ({ isEditMode = false, onCampaignSelect }) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    {campaigns.map((biz, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`bg-zinc-900 rounded-lg overflow-visible relative cursor-pointer ${isEditMode && isSelected ? "ring-2 ring-green-500" : ""}`}
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Link to={`/campaign/${biz.id}`}><FaEye /></Link>
                                    </div>
